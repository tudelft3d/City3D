...
namespace easy3d {
    ...
    namespace io {
        ...
        bool load_las(const std::string &file_name, PointCloud *cloud) {
            ...
            auto v = cloud->add_vertex(vec3_(float(x0 - origin_x), float(y0 - origin_y), float(z0 - origin_z)));
            colors[v] = vec3_(r, g, b);
            ...
            while (lasreader->read_point()) {
                ...
                v = cloud->add_vertex(vec3_(float(x), float(y), float(z)));

...
namespace easy3d {
    ...
    namespace io {
        ...
        bool load_sm(const std::string& file_name, SurfaceMesh* mesh)
        {
			...
			auto point = mesh->vertex_property<vec3_>("v:point");
            ...
            if (has_colors) {
                SurfaceMesh::VertexProperty<vec3_> color = mesh->vertex_property<vec3_>("v:color");
        ...
        bool save_sm(const std::string& file_name, const SurfaceMesh* mesh)
        {
            ...
            auto point = mesh->get_vertex_property<vec3_>("v:point");

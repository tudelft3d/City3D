	...
	namespace io {
        ...
        bool load_ply(const std::string& file_name, Graph* graph)
		{
			...
			for (const auto& e : elements) {
                if (e.name == "vertex") {
                    internal::add_vertex_properties<vec3_>(graph, e.vec3_properties);
                    internal::add_vertex_properties<vec2_>(graph, e.vec2_properties);
                    ...
                    internal::add_edge_properties<vec3_>(graph, e.vec3_properties);
                    internal::add_edge_properties<vec2_>(graph, e.vec2_properties);

...
namespace easy3d {
	...
	namespace io {
		...
		bool load_bin(const std::string& file_name, PointCloud* cloud) {
			...
			auto points = cloud->vertex_property<vec3_>("v:point");
            ...
            input.read((char*)(&num), sizeof(int));
            if (num > 0) {
				PointCloud::VertexProperty<vec3_> colors = cloud->vertex_property<vec3_>("v:color");
            ...
            input.read((char*)(&num), sizeof(int));
            if (num > 0) {
				PointCloud::VertexProperty<vec3_> normals = cloud->vertex_property<vec3_>("v:normal");
		...
		bool save_bin(const std::string& file_name, const PointCloud* cloud) {
			...
			auto colors = cloud->get_vertex_property<vec3_>("v:color");
            if (colors) {
                output.write((char *) &num, sizeof(int));

                ...
                if (0 == strcmp(str, "Dimension")) {
                    ...
                    if (Translator::instance()->status() == Translator::DISABLED) {
                        ...
                        for (int i = 0; i < number_of_vertices; i++) {
                            ...
                            vertices[i] = mesh->add_vertex(vec3_(static_cast<float>(x), static_cast<float>(y), static_cast<float>(z)));
                        ...
                        for (int i = 0; i < number_of_vertices; i++) {
                            ...
                            vertices[i] = mesh->add_vertex(vec3_(static_cast<float>(x - x0), static_cast<float>(y - y0), static_cast<float>(z - z0)));
                            progress.notify(ftell(mesh_file));
                        }
                        ...
                        for (int i = 0; i < number_of_vertices; i++) {
                            ...
                            vertices[i] = mesh->add_vertex(vec3_(static_cast<float>(x - origin.x), static_cast<float>(y - origin.y), static_cast<float>(z - origin.z)));
                            progress.notify(ftell(mesh_file));
                        }

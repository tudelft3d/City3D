...
namespace easy3d {
	...
	public:
         ...
         *      direction.
         */
		virtual vec3_ point_under_pixel(int x, int y, bool &found) const;
	...
	protected:
        ...
        void draw_face_labels(Model* model, TextRenderer* texter, int font_id, const vec3_& color) const;
        void draw_vertex_labels(Model* model, TextRenderer* texter, int font_id, const vec3_& color) const;

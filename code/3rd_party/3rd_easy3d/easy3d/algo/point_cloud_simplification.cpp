    ...
    namespace internal {
        ...
        public:
            ...
            bool operator()(const Point &a, const Point &b) const {
                const vec3_ *a_n = (a.pos);
                const vec3_ *b_n = (b.pos);

                vec3_ rounded_a(round_epsilon(a_n->x, m_epsilon), round_epsilon(a_n->y, m_epsilon),
                                round_epsilon(a_n->z, m_epsilon));
                vec3_ rounded_b(round_epsilon(b_n->x, m_epsilon), round_epsilon(b_n->y, m_epsilon),

...
namespace easy3d {
    ...
    public:
        ...
        NearestNeighbor nearest(const vec3_ &p) const;
    ...
    private:
        ...
        struct Triangle {
            ...
            Triangle(const vec3_ &x0, const vec3_ &x1, const vec3_ &x2, SurfaceMesh::Face ff) {
                x[0] = x0;
                x[1] = x1;
                x[2] = x2;
                f = ff;
        ...
        void nearest_recurse(Node *node, const vec3_ &point, NearestNeighbor &data) const;

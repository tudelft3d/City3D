...
namespace easy3d {
    ...
    public:
        ...
        struct Vertex : std::vector<double> {
             ...
             */
            explicit Vertex(const vec3_ &xyz, int idx = 0) : index(idx) { append(xyz); }
             ...
             * @tparam Vec The vector type of the vertex property, e.g., vec2_, vec3_.
    ...
    public:
         ...
         */
        void begin_polygon(const vec3_ &normal);
        /**
         * @brief Begin the tessellation of a complex polygon.
        ...
        /** @overload **/
        void add_vertex(const vec3_ &xyz, int idx = 0);
        /** @overload **/
        void add_vertex(const vec3_ &xyz, const vec2_ &t, int idx = 0);
        /** @overload **/
        void add_vertex(const vec3_ &xyz, const vec3_ &v1, int idx = 0);
        /** @overload **/
        void add_vertex(const vec3_ &xyz, const vec3_ &v1, const vec2_ &t, int idx = 0);
        /** @overload **/
        void add_vertex(const vec3_ &xyz, const vec3_ &v1, const vec3_ &v2, int idx = 0);
        /** @overload **/
        void add_vertex(const vec3_ &xyz, const vec3_ &v1, const vec3_ &v2, const vec2_ &t, int idx = 0);

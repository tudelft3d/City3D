...
namespace easy3d {
    ...
    bool SurfaceMeshSubdivision::catmull_clark(SurfaceMesh *mesh) {
        ...
        auto points = mesh->vertex_property<vec3_>("v:point");
        ...
        // get properties
        auto vpoint = mesh->add_vertex_property<vec3_>("catmull:vpoint");
        auto epoint = mesh->add_edge_property<vec3_>("catmull:epoint");
        auto fpoint = mesh->add_face_property<vec3_>("catmull:fpoint");
    ...
    bool SurfaceMeshSubdivision::loop(SurfaceMesh *mesh) {
        ...
        // add properties
        auto vpoint = mesh->add_vertex_property<vec3_>("loop:vpoint");
        auto epoint = mesh->add_edge_property<vec3_>("loop:epoint");
    ...
    bool SurfaceMeshSubdivision::sqrt3(SurfaceMesh *mesh) {
        ...
        auto new_pos = mesh->add_vertex_property<vec3_>("v:np");
        for (auto v : mesh->vertices()) {
            if (!mesh->is_border(v)) {

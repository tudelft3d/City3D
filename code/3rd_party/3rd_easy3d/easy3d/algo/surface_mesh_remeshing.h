...
namespace easy3d {
    ...
    private:
        ...
        void remove_caps();
        vec3_ minimize_squared_areas(SurfaceMesh::Vertex v);
        vec3_ weighted_centroid(SurfaceMesh::Vertex v);
    ...
    private:
        ...
        SurfaceMesh::VertexProperty <vec3_> points_;
        SurfaceMesh::VertexProperty <vec3_> vnormal_;
        ...
        SurfaceMesh::VertexProperty <vec3_> refpoints_;
        SurfaceMesh::VertexProperty <vec3_> refnormals_;

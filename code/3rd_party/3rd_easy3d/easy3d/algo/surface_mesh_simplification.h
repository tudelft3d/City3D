...
namespace easy3d {
    ...
    public:
        ...
        Quadric(const vec3_ &n, const vec3_ &p) {
        ...
        double operator()(const vec3_ &p) const {
    ...
    public:
        ...
        explicit NormalCone(const vec3_ &normal, float angle = 0.0)
                : center_normal_(normal), angle_(angle) {
        }

        //! returns center normal
        const vec3_ &center_normal() const { return center_normal_; }

        //! returns size of cone (radius in radians)
        float angle() const { return angle_; }

        //! merge *this with n.
        NormalCone &merge(const vec3_ &n) { return merge(NormalCone(n)); }
    ...
    private:
        ...
        */
        ...
        typedef std::vector<vec3_> Points;
    ...
    private:
        ...
        float distance(SurfaceMesh::Face f, const vec3_ &p) const;
    ...
    private:
        ...
        SurfaceMesh::VertexProperty<vec3_> vpoint_;
        SurfaceMesh::FaceProperty<vec3_> fnormal_;

...
namespace easy3d {
    ...
    SurfaceMesh::Vertex SurfaceMeshBuilder::add_vertex(const vec3_ &p) {
    ...
    SurfaceMesh::Vertex SurfaceMeshBuilder::copy_vertex(Vertex v) {
        const vec3_ p = mesh_->position(v); // [Liangliang]: 'const vec3_&' won't work because the vector is growing.

...
namespace easy3d {
    ...
    public:
         ...
         */
        int find_closest_point(const vec3_ &p, float &squared_distance) const override;
         ...
         * \return The index of the nearest neighbor found.
         */
        int find_closest_point(const vec3_ &p) const override;
        /// @}
        ...
        void find_points_in_range(
                const vec3_ &p, float squared_radius,
                std::vector<int> &neighbors, std::vector<float> &squared_distances
        ) const override;

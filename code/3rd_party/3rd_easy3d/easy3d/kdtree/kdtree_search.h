...
namespace easy3d {
    ...
    public:
         ...
         */
        virtual int find_closest_point(const vec3_ &p, float &squared_distance) const = 0;
         ...
         * \return The index of the nearest neighbor found (the same as in the original point cloud).
         */
        virtual int find_closest_point(const vec3_ &p) const = 0;
        /// @}
         ...
         */
        virtual void find_closest_k_points(const vec3_ &p, int k, std::vector<int> &neighbors,
         ...
         * \param neighbors The indices of the neighbors found (the same as in the original point cloud).
         */
        virtual void find_closest_k_points(const vec3_ &p, int k, std::vector<int> &neighbors) const = 0;
        /// @}
         ...
         * \note The \b squared distances are returned by the argument \p squared_distances.
         */
        virtual void find_points_in_range(const vec3_ &p, float squared_radius, std::vector<int> &neighbors,
                                          std::vector<float> &squared_distances) const = 0;
         ...
         * \param neighbors The indices of the neighbors found (the same as in the original point cloud).
         */
        virtual void find_points_in_range(const vec3_ &p, float squared_radius, std::vector<int> &neighbors) const = 0;
        /// @}
    };

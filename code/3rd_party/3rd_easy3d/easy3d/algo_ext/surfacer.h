...
namespace easy3d {
    ...
    public:
        ...
        typedef std::vector<vec3_> Polyline;
    ...
    public:
         ...
         *      orient_and_stitch_polygon_soup(std::vector<vec3_>& points, std::vector<Polygon>& polygons).
         * \see merge_reversible_connected_components()
         */
         ...
         */
        static bool orient_and_stitch_polygon_soup(std::vector<vec3_> &points, std::vector<Polygon> &polygons);
         ...
         */
        static void repair_polygon_soup(std::vector<vec3_> &points, std::vector<Polygon> &polygons);
         ...
         * clean_polygon_soup(std::vector<vec3_>& points, std::vector<Polygon>& polygons).

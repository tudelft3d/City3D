...
namespace easy3d {
    ...
    public:
         ...
         *            a Retina display.
         */
        vec3_ picking_dir(int x, int y) const {
         ...
         *            a Retina display.
         */
        vec3_ project(const vec3_ &p) const {
         ...
         *            a Retina display.
         */
        vec3_ unproject(int x, int y, float depth) const {
            return camera()->unprojectedCoordinatesOf(vec3_(static_cast<float>(x), static_cast<float>(y), depth));
        }

...
namespace easy3d {
              ...
              cross_section_width_(0.001f), scene_radius_(1.0f)
    {
        ...
        constraint.setTranslationConstraint(AxisPlaneConstraint::AXIS, vec3_(0, 0, 1));
    ...
    void ClippingPlane::fit_scene(const vec3_ &center, float radius) {

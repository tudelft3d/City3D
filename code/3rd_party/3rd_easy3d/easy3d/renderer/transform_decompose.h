...
namespace easy3d {
    ...
    namespace transform {
         ...
         *      - vec3_ extract_scale(const mat4& M);
         *      - vec3_ extract_translation(const mat4& M);
         */
         ...
         * \todo Not tested yet.
         */
        bool decompose(const mat4& M, vec3_& scaling, quat& rotation, vec3_& translation, vec3_& skew, vec4& persp);

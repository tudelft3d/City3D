...
namespace easy3d {
    ...
    public:
         ...
         * \sa keyframe_time()
         */
        void set_keyframe_position(std::size_t index, const vec3_& pos);
    ...
    public:
         ...
         */
        const vec3_& keyframe_position(std::size_t index) const;
    ...
    private:
        ...
        public:
            ...
            const vec3_& position() const { return p_; }
            const quat& orientation() const { return q_; }
            float time() const { return time_; }
            void set_time(float t) { time_ = t; }
            void set_position(const vec3_& p) { p_ = p; }

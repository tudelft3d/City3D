...
namespace easy3d {
	...
	public:
		...
		//		 'uniform vec2_/float values[8]' in your shader code, the uniform name is 'values[0]' (not 'values').
		 ...
		 *		vec4 (i.e., 16-bytes).
		 *		So we have to avoid using vec3_/mat3 (use vec4/mat4/mat43 instead) in a uniform block. Otherwise,

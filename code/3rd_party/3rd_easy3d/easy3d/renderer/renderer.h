...
namespace easy3d {
    ...
    public:
        ...
        static void color_from_segmentation(
                ...
                SurfaceMesh::FaceProperty<vec3_> colors
        );
        ...
        static void color_from_segmentation(
                ...
                SurfaceMesh::VertexProperty<vec3_> colors
        );
        ...
        static void color_from_segmentation(
                ...
                PointCloud::VertexProperty<vec3_> colors
        );
...
namespace easy3d {
    ...
    void Renderer::color_from_segmentation(SurfaceMesh *mesh, SurfaceMesh::FaceProperty<FT> segments,
        ...
        std::vector<vec3_> color_table(max_index + 1);   // index starts from 0

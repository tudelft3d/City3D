...
namespace easy3d {
    ...
    float
    TextRenderer::draw(const std::string &text, float x, float y, float font_size, int font_id, const vec3_ &font_color,
    ...
    void TextRenderer::flush_draw(const vec3_ &font_color) const {
...
#define FONT_STASH_LINE_HEIGHT_MULT    0.9f
    ...
    Rect TextRenderer::draw(const std::string &text, float x0, float y0, float font_size, Align align,
                            int font_id, const vec3_ &font_color, float line_spacing, bool upper_left) const {

...
namespace easy3d {
    ...
    public:
         ...
         */
        void update_vertex_buffer(const std::vector<vec3_> &vertices, bool dynamic = false);
        void update_color_buffer(const std::vector<vec3_> &colors, bool dynamic = false);
        void update_normal_buffer(const std::vector<vec3_> &normals, bool dynamic = false);
        void update_texcoord_buffer(const std::vector<vec2_> &texcoords, bool dynamic = false);

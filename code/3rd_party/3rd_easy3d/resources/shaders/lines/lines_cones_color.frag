...
vec3_ shade(vec3_ N, vec3_ L, vec3_ V, vec3_ amb, vec3_ spec, float sh, vec3_ color) {
...
void main()
{
	...
	if (lighting) {
		...
		vec3_ final_color = shade(normal, light_dir, view_dir, ambient, specular, shininess, gOutColor.xyz);

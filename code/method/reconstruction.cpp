...
bool save_footprint(PointSet *roof_pset, Map::Facet *footprint, const std::string footprint_file_name) {
    // save footprint
    Polygon3d plg;
                                                 ...
                                                 int& status)
{
    ...
    if (!hypothesis) {
        if (!save_footprint(roof_pset, footprint, footprint_file_name))

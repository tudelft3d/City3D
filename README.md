...
* Dependencies (Attention for Windows users: ALL dependencies must be for `x64`)
    ...
    - [CGAL](http://www.cgal.org/index.html) (v5.4 and v5.5 have been tested). **Attention**: Newer versions of CGAL (v5.6 and later) may not work since these versions introduced breaking changes to the APIs. We will solve this soon.
